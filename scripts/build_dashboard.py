...
Food Sales Dashboard Generator
Generates a multi-page PDF report analyzing food sales.
...
OUTPUT_FILE = os.path.join(_ROOT, 'output', 'food_dashboard.pdf')
...
# -- Category colors --
CATEGORY_COLORS = {
    'Appetizers & Sides': AMBER,
    'Wings & Chicken':    CORAL,
    'Pizza':              GREEN,
    'Burgers & Sliders':  BLUE,
    'Sandwiches':         PURPLE,
    'Tacos & Mexican':    TEAL,
    'Salads':             LIME,
    'Kids Menu':          PINK,
    'Beverages':          SKY,
    'Soups':              GOLD,
    'Party Platters':     ORANGE,
}

# Category display order (by typical revenue weight)
CATEGORY_ORDER = [
    'Appetizers & Sides', 'Wings & Chicken', 'Pizza', 'Beverages',
    'Burgers & Sliders', 'Sandwiches', 'Tacos & Mexican', 'Salads',
    'Party Platters', 'Kids Menu', 'Soups',
]

# =============================================================================
# NAME MERGES  (early-season labeling variants -> canonical names)
# =============================================================================
...
# =============================================================================
# CATEGORY MAPPING  (78 items -> 11 categories)
# =============================================================================

CATEGORY_MAP = {
    # Burgers & Sliders (6)
    'Smash Burger':           'Burgers & Sliders',
    'Classic Cheeseburger':   'Burgers & Sliders',
    'Cali Burger':            'Burgers & Sliders',
    'BBQ Bacon Cheeseburger': 'Burgers & Sliders',
    'Sliders':                'Burgers & Sliders',

    # Pizza (10)
    'BYO Pizza':              'Pizza',
    'Meat Lovers':            'Pizza',
    'HH MED PEPPERONI':       'Pizza',
    'Hot Honey Pep':          'Pizza',
    'Bbq Chicken':            'Pizza',
    'Hawaiian':               'Pizza',
    'Veggie Lovers':          'Pizza',
    ...
    'Chicken Strips':         'Wings & Chicken',
    'Buffalo Chicken Strips': 'Wings & Chicken',
    'Chicken Breast':         'Wings & Chicken',

    # Appetizers & Sides (15)
    'French Fries':           'Appetizers & Sides',
    'Mozzarella Sticks':      'Appetizers & Sides',
    'Waffle Fries':           'Appetizers & Sides',
    'Onion Rings':            'Appetizers & Sides',
    'Pretzel Sticks':         'Appetizers & Sides',
    'Mini Corn Dogs':         'Appetizers & Sides',
    'Concourse Nacho':        'Appetizers & Sides',
    'Irish Nachos':           'Appetizers & Sides',
    'Chips and Cheese':       'Appetizers & Sides',
    'Hummus Trio':            'Appetizers & Sides',
    'Veggie Tray':            'Appetizers & Sides',
    'Hard boiled Egg':        'Appetizers & Sides',

    # Salads (7)
    'Cobb Salad':             'Salads',
    'House Salad':            'Salads',
    'Caesar Salad':           'Salads',
    'Chinese Chicken Salad':  'Salads',
    'Taco Salad':             'Salads',
    'Fried Chicken Salad':    'Salads',
    'Red Plum Salad':         'Salads',

    # Tacos & Mexican (8)
    'Quesadilla':                  'Tacos & Mexican',
    'Taco Plate':                  'Tacos & Mexican',
    'Shrimp Tacos':                'Tacos & Mexican',
    'Southwest Bowl':              'Tacos & Mexican',
    'Carne Asada Torta':           'Tacos & Mexican',
    ...
    # Kids Menu (2)
    'Kids Chicken Strips':    'Kids Menu',
    'Kids Sliders':           'Kids Menu',

    # Beverages (7)
    'Soda':                   'Beverages',
    'Refill':                 'Beverages',
    'Soda Pitcher':           'Beverages',
    'Online Soda':            'Beverages',
    'Bottled Water':          'Beverages',
    'online soda pitcher':    'Beverages',
    'Unlimited Soda':         'Beverages',

    # Party Platters (12)
    'Party Platters - French Fries':     'Party Platters',
    'Party Platter - Wings':             'Party Platters',
    'Party Platters - Large Salad Bowl': 'Party Platters',
    'Party Platters - Corn Dogs/Fries':  'Party Platters',
    'Party Fry Platter':                 'Party Platters',
    'Party Platters - Mnstr Nacho Chk':  'Party Platters',
    'Party Platters - Veg Hum & Pita':   'Party Platters',
    'Party Platters - Chips & Salsa':    'Party Platters',
    'Party Platters - Veggies & Ranch':  'Party Platters',
    'Party Platters - Mnstr Nacho Beef': 'Party Platters',
    'Party Salad Bowl':                  'Party Platters',
    'Party Unlimited Soda':              'Party Platters',
}
...
def _read_transactions():
    ...
    with open(DATA_FILE, 'r', encoding='utf-8') as f:
        ...
        idx = {c: header.index(c) for c in [
            ...
            'Department', 'Quantity', 'Unit Amount',
...
def page_executive_summary(pdf, data):
    ...
    ax.text(5.5, 7.82, 'FOOD SALES DASHBOARD',
    ...
    # ---- Footer note ----
    ax.text(5.5, 0.22,
            'Note: Some items (BYO Pizza, Bowlers Combo, etc.) show $0 revenue '
            '-- pricing captured on parent items.',
...
def page_revenue_rankings(pdf, data):
    ...
    note = (f'Top 10 items = {pct:.0f}% of total food revenue  '
